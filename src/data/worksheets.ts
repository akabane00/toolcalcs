...
export const worksheets: Worksheet[] = [
  ...
  },
  {
    ...
    description: 'Free printable integers worksheets for grades 5-7. Practice adding, subtracting, multiplying, and dividing positive and negative numbers. Division always yields integer results.',
    icon: '±',
    gradeRange: '5-7',
    mathTopic: 'Integers',
    configOptions: [
      { name: 'problems', label: 'Number of Problems', type: 'number', default: 20, min: 15, max: 30 },
      ...
      { name: 'range', label: 'Range', type: 'select', default: '10', options: [{ value: '10', label: 'Small (-10 to 10)' }, { value: '50', label: 'Medium (-50 to 50)' }, { value: '100', label: 'Large (-100 to 100)' }] },
    ],
  },
  {
    title: 'Coordinate Plane Worksheets',
    slug: 'coordinate-plane-worksheets',
    description: 'Free printable coordinate plane worksheets for grades 5-7. Practice plotting points, identifying coordinates, and finding distances with printable coordinate grids. Generate unlimited problems.',
    icon: '📍',
    gradeRange: '5-7',
    mathTopic: 'Coordinate Plane',
    configOptions: [
      { name: 'problems', label: 'Number of Problems', type: 'number', default: 10, min: 8, max: 15 },
      { name: 'type', label: 'Problem Type', type: 'select', default: 'mixed', options: [{ value: 'plot', label: 'Plot Points' }, { value: 'identify', label: 'Identify Coordinates' }, { value: 'distance', label: 'Find Distance' }, { value: 'mixed', label: 'Mixed' }] },
      { name: 'grid', label: 'Grid Range', type: 'select', default: '5', options: [{ value: '5', label: '5 x 5' }, { value: '10', label: '10 x 10' }, { value: 'all', label: 'All Four Quadrants' }] },
    ],
  },
];
